...
class HistoryOrderClient extends StatefulWidget {
  @override
  State<HistoryOrderClient> createState() => _HistoryOrderClientState();
}

class _HistoryOrderClientState extends State<HistoryOrderClient> {
  ...
  Future<List<Map<String, dynamic>>> getCompletedOrders() async {
    ...
    final url = Uri.parse(urlMain + 'getBackOrderByClient');
    print(url);
